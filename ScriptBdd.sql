...
INSERT INTO `projet_final_api`.`reviews` (`reviewId`, `username`, `title`, `note`, `comment`, `like`, `moviename`) VALUES ('1', 'user', 'Review star wars', '5', 'WAaa film incredible', '2', 'Star Wars');
INSERT INTO `projet_final_api`.`reviews` (`reviewId`, `username`, `title`, `note`, `comment`, `like`, `moviename`) VALUES ('2', 'user2', 'Review star wars 2', '1', 'Sacrément nul ', '5', 'Star Wars 2');
INSERT INTO `projet_final_api`.`reviews` (`reviewId`, `username`, `title`, `note`, `comment`, `like`, `moviename`) VALUES ('3', 'user2', 'Review star wars 3', '3', 'Mouais ça va', '1', 'Star Wars 3');
INSERT INTO `projet_final_api`.`reviews` (`reviewId`, `username`, `title`, `note`, `comment`, `like`, `moviename`) VALUES ('4', 'user', 'Review star wars 4', '2', 'incroyable mieux que le premier', '10', 'Star Wars 4');
*/